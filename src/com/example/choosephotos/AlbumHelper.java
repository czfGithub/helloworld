...
public class AlbumHelper {
	 ...
	 * @param imageLists 
	 */
	void buildImagesBucketList(List<ImageItem> imageLists) {
	 ...
	 * @return
	 */
	public List<ImageBucket> getImagesBucketList(boolean refresh,List<ImageItem> imageLists) {
		if (refresh || (!refresh && !hasBuildImagesBucketList)) {
			buildImagesBucketList(imageLists);
		}
		...
		while (itr.hasNext()) {
			...
			imageLists.addAll(bucket.imageList);
		}
		return tmpList;
	}
